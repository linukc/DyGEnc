            ...
            for item_idx, item in enumerate(tqdm(json_data)):
                ...
                if answer_id == "not_found":
                    ...
                    if "the" in item["answer"]:
                        ...
                        answer_id = text2nodeid.get(object_base.rstrip(".").lower().strip(), "not_found")
                    else:
                    # case3
                ...
                for idx in random_idx_to_operate:
                    graph = sg_seq_nx[idx]
                    graph.remove_node(answer_idx_list[idx])
                ###
